        ...
        <div className="animate-fade-in space-y-6">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div className="p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 flex justify-between items-center">
              ...
              <span className="text-xs text-gray-500 italic">Ketuk status untuk mengubah</span>
            </div>
              ...
              {studentsInClass.map(student => (
                <li key={student.id} className="p-4 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                  ...
                  <button
                    ...
                    className={`
                                            w-28 md:w-32 py-2 px-3 rounded-xl flex items-center justify-center gap-2 font-semibold border transition-all active:scale-95
                                            ${getStatusColor(attendance[student.id] || 'H')}
                                        `}
                  >
                    {getStatusIcon(attendance[student.id] || 'H')}
                    <span>{getStatusLabel(attendance[student.id] || 'H')}</span>
                  </button>
                </li>
              ))}
            </ul>
